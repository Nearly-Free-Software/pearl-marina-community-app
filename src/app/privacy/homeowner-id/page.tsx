    ...
    <main className="min-h-screen px-5 py-10">
      <Card className="mx-auto max-w-2xl">
        ...
        <CardContent className="space-y-5 text-sm leading-7 text-muted-foreground">
          <p>Pearl Marina collects one image of a government-issued photo ID to help a community manager compare the applicant’s confirmed name and photograph while reviewing homeowner access.</p>
          ...
          <p>Do not submit an ID unless you accept this processing. For a privacy request or incident report, contact the Pearl Marina community management team through the community’s established contact channel.</p>
