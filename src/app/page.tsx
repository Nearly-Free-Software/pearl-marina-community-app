      ...
      <div className="mx-auto flex min-h-screen w-full max-w-5xl flex-col px-5 py-6 sm:px-8">
        ...
        <section className="flex flex-1 flex-col justify-center py-20">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 max-w-xl text-pretty text-lg leading-8 text-muted-foreground">A mobile-first home for homeowners, residents, and the teams who help our community run smoothly.</p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Button asChild size="lg"><Link href="/login">Continue to sign in <ArrowRight className="size-4" /></Link></Button>
            </div>
